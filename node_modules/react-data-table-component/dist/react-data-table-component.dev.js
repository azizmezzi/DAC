...
var ButtonStyle = styled__default.button(_templateObject$7(), function (props) {
  return props.theme.expander[props.expanded ? 'expandedButton' : 'collapsedButton'];
});
...
var ExpanderRow = function ExpanderRow(_ref) {
  var data = _ref.data,
      children = _ref.children;
  return React__default.createElement(ExpanderRowStyle, null, renderChildren(children, data));
};
...
var TableColStyle = styled__default(Cell)(_templateObject$b(), function (props) {
  ...
  return props.sortable && props.sortDirection === 'asc' && !props.sortIcon && styled.css(_templateObject2$4());
}, function (props) {
  return props.sortable && props.sortDirection === 'desc' && !props.sortIcon && styled.css(_templateObject3$2());
});
...
function (_PureComponent) {
  ...
  _createClass(TableCol, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(DataTableConsumer, null, function (_ref) {
        var sortIcon = _ref.sortIcon,
            sortColumn = _ref.sortColumn,
            sortDirection = _ref.sortDirection,
            internalCell = _ref.internalCell;
...
var TableCol$1 = React.memo(function (_ref) {
  ...
  return React__default.createElement(DataTableConsumer, null, function (_ref2) {
    ...
    return React__default.createElement(TableColStyle$1, null, React__default.createElement(Checkbox, {
...
var TableHeader = function TableHeader(_ref) {
  ...
  return React__default.createElement(TableHeaderStyle, null, React__default.createElement(Title$1, null, title), React__default.createElement(Actions, null, actions), React__default.createElement(ContextMenu, null));
};
...
var TableBody = styled__default.div(_templateObject$g(), function (props) {
  return props.fixedHeader && styled.css(_templateObject2$7(), props.hasOffset ? "calc(100vh - ".concat(props.offset || 0, ")") : '100vh');
});
...
function (_PureComponent) {
  ...
  function Pagination() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleLast", function () {
      var onChangePage = _this.props.onChangePage;
      onChangePage(_this.getNumberOfPages());
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleRowsPerPage", function (_ref) {
      ...
      var _this$props3 = _this.props,
          ...
          onChangeRowsPerPage = _this$props3.onChangeRowsPerPage;
      onChangeRowsPerPage(Number(target.value)); // TODO: fix empty array on perRows change
  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      var status = currentPage === numPages ? "".concat(firstIndex, "-").concat(rowCount, " of ").concat(rowCount) : "".concat(firstIndex, "-").concat(lastIndex, " of ").concat(rowCount);
      var disabledLesser = currentPage === 1;
      var disabledGreater = currentPage === numPages;
      return React__default.createElement(DataTableConsumer, null, function (_ref2) {
        var paginationPerPage = _ref2.paginationPerPage,
            paginationRowsPerPageOptions = _ref2.paginationRowsPerPageOptions,
        ...
        return React__default.createElement(React__default.Fragment, null, React__default.createElement(Span, null, "Rows per page:"), React__default.createElement(Select, {
          onChange: _this2.handleRowsPerPage,
...
function (_Component) {
  ...
  function DataTable(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSort", function (_ref) {
      ...
      _this.setState(function (state) {
        return handleSort(selector, sortable, state);
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleChangeRowsPerPage", function (rowsPerPage) {
    ...
    var _sortDirection = getSortDirection(props.defaultSortAsc);
    ...
    _this.PaginationComponent = props.paginationComponent;
    _this.state = {
      allSelected: false,
      selectedCount: 0,
      selectedRows: [],
  ...
  _createClass(DataTable, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (onTableUpdate && (prevState.selectedRows !== selectedRows || prevState.sortDirection !== sortDirection || prevState.sortColumn !== sortColumn)) {
        var _this$state3 = this.state,
            ...
            selectedCount = _this$state3.selectedCount,
            clearSelectedRows = _this$state3.clearSelectedRows;
        onTableUpdate({
          allSelected: allSelected,
    ...
    value: function renderColumns() {
      ...
      return this.columns.map(function (column) {
        return React__default.createElement(TableCol, {
          key: column.id,
          column: column,
          onColumnClick: _this2.handleSort
        });
      });
    }
  }, {
    ...
    value: function renderRows() {
      ...
      var currentRows = pagination ? sortedRows.slice(firstIndex, lastIndex) : sortedRows;
      return currentRows.map(function (row, i) {
    ...
    value: function renderTableHead() {
      var _this$props3 = this.props,
          selectableRows = _this$props3.selectableRows,
          expandableRows = _this$props3.expandableRows;
      return React__default.createElement(TableHead, null, React__default.createElement(TableHeadRow, null, selectableRows && React__default.createElement(TableCol$1, {
        onClick: this.handleSelectAll
      }), expandableRows && React__default.createElement("div", {
        style: {
          width: '48px'
        }
      }), this.renderColumns()));
    ...
    value: function render() {
      var _this$props4 = this.props,
          ...
          customTheme = _this$props4.customTheme,
          actions = _this$props4.actions,
          className = _this$props4.className,
          style = _this$props4.style,
          responsive = _this$props4.responsive,
          overflowY = _this$props4.overflowY,
          overflowYOffset = _this$props4.overflowYOffset,
          progressPending = _this$props4.progressPending,
          progressComponent = _this$props4.progressComponent,
          progressCentered = _this$props4.progressCentered,
          noDataComponent = _this$props4.noDataComponent,
          disabled = _this$props4.disabled,
          noHeader = _this$props4.noHeader,
          ...
          subHeader = _this$props4.subHeader,
          subHeaderAlign = _this$props4.subHeaderAlign,
          subHeaderWrap = _this$props4.subHeaderWrap,
          subHeaderComponent = _this$props4.subHeaderComponent;
      ...
      }, this.renderRows())), enabledPagination && React__default.createElement(TableFooter, null, React__default.createElement(this.PaginationComponent, {
